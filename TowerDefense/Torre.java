...
public abstract class Torre {
    ...
    protected Tropa tropa;  //TODO no deberia conocer a la tropa ni sus coordenadas
    private int danio;
    private int precio;
    ...
    protected final AtacadorDeTorre atacT = new AtacadorDeTorre(this);
    ...
    public abstract void atacarCasilla();
