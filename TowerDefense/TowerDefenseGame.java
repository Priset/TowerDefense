...
public class TowerDefenseGame {
    ...
    public void colaDeEnemigos(){
        ...
        for(int i = 0; i < 30; i++) {
            enemigos.add(new Tropa("Golem",500,25,50,"tropa_tipo3"));
        }
        for(int i = 0; i < 30; i++) {
            enemigos.add(new Tropa("Ogro",950,50,70,"tropa_tipo4"));
        }
    }
    ...
    public void iniciarPartida(){
        ...
        //TODO ACA SE PONDRA QUE LAS TORRES ATAQUEN Y LOS ENEMIGOS AVANZEN CON UN BOTON
    }
